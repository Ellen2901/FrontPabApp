    ...
    >
      <div className="w-[22rem] p-8 bg-white/20 backdrop-blur-md rounded-[20px] shadow-lg flex flex-col gap-6">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-bold text-white">Entre com SSO</h2>
          <h3 className="text-sm text-white mt-2">Preencha seu e-mail institucional</h3>
        </div>
        ...
        <p className="text-sm text-white text-center">
          Não tem um cadastro?{" "}
          <a href="/cadastro" className="text-purple-800 hover:underline">Cadastre-se</a>
        </p>
      </div>
    </div>
